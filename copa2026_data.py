...
SELECOES = [
    ...
    {"nome": "Escócia", "codigo": "SCO", "bandeira": "🏴󠁧󠁢󠁳󠁣󠁴󠁿", "grupo": "C"},
    ...
    # Grupo L
    {"nome": "Inglaterra", "codigo": "ENG", "bandeira": "🏴󠁧󠁢󠁥󠁮󠁧󠁿", "grupo": "L"},
...
JOGOS_FASE_GRUPOS = [
    ...
    # 13 de Junho
    (11, "NZL", "B2", "2026-06-13", "07:00", "Vancouver", "Grupos", "G"),
    ...
    (23, "SUI", "IRN", "2026-06-14", "13:00", "Los Angeles", "Grupos", "G"),
    ...
    # 15 de Junho
    (27, "POR", "NED", "2026-06-15", "16:00", "Houston", "Grupos", "K"),
    ...
    (39, "RSA", "KSA", "2026-06-17", "19:00", "Atlanta", "Grupos", "H"),
    
    # 18 de Junho
    (40, "CAN", "NZL", "2026-06-18", "07:00", "Vancouver", "Grupos", "B"),
    (41, "USA", "D4", "2026-06-18", "13:00", "Seattle", "Grupos", "D"),
    (42, "PAR", "AUS", "2026-06-18", "10:00", "San Francisco", "Grupos", "D"),
    (43, "BEL", "IRN", "2026-06-18", "13:00", "Los Angeles", "Grupos", "G"),
    (44, "COL", "K4", "2026-06-18", "22:00", "Guadalajara", "Grupos", "K"),
    (45, "TUN", "JPN", "2026-06-18", "22:00", "Monterrey", "Grupos", "F"),
    (46, "ARG", "AUT", "2026-06-18", "19:00", "Dallas", "Grupos", "J"),
    (47, "URU", "CPV", "2026-06-18", "19:00", "Miami", "Grupos", "H"),
    (48, "GER", "PAN", "2026-06-18", "16:00", "Toronto", "Grupos", "E"),
    (49, "SCO", "MAR", "2026-06-18", "19:00", "Boston", "Grupos", "C"),
    (50, "FRA", "I3", "2026-06-18", "22:00", "New York", "Grupos", "I"),
    
    # 19 de Junho
    (51, "SUI", "NZL", "2026-06-19", "07:00", "Vancouver", "Grupos", "B"),
    (52, "QAT", "EGY", "2026-06-19", "13:00", "Seattle", "Grupos", "B"),
    ...
    (56, "USA", "AUS", "2026-06-19", "13:00", "Los Angeles", "Grupos", "D"),
    (57, "RSA", "A4", "2026-06-19", "22:00", "Mexico City", "Grupos", "A"),
    (58, "POR", "UZB", "2026-06-19", "16:00", "Houston", "Grupos", "K"),
    (59, "JPN", "JOR", "2026-06-19", "19:00", "Dallas", "Grupos", "F"),
    (60, "TUN", "ALG", "2026-06-19", "19:00", "Kansas City", "Grupos", "F"),
    ...
    # 20 de Junho - Última rodada grupos (jogos simultâneos)
    (67, "NZL", "BEL", "2026-06-20", "16:00", "Vancouver", "Grupos", "G"),
    (68, "EGY", "IRN", "2026-06-20", "16:00", "Seattle", "Grupos", "G"),
    (69, "CAN", "SUI", "2026-06-20", "16:00", "Vancouver", "Grupos", "B"),
    (70, "QAT", "B2", "2026-06-20", "16:00", "Seattle", "Grupos", "B"),
    
    # 21 de Junho
    (71, "AUS", "D4", "2026-06-21", "19:00", "San Francisco", "Grupos", "D"),
    (72, "USA", "PAR", "2026-06-21", "19:00", "San Francisco", "Grupos", "D"),
    (73, "MEX", "A4", "2026-06-21", "22:00", "Mexico City", "Grupos", "A"),
    (74, "RSA", "KOR", "2026-06-21", "22:00", "Mexico City", "Grupos", "A"),
    ...
    (79, "ARG", "JOR", "2026-06-22", "19:00", "Dallas", "Grupos", "J"),
    ...
    (86, "E2", "GER", "2026-06-23", "22:00", "Philadelphia", "Grupos", "E"),
    (87, "CIV", "ECU", "2026-06-23", "22:00", "Philadelphia", "Grupos", "E"),
    (88, "ECU", "PAN", "2026-06-23", "22:00", "New York", "Grupos", "E"),
    ...
    (92, "NOR", "FRA", "2026-06-24", "19:00", "Boston", "Grupos", "I"),
    (93, "I3", "SEN", "2026-06-24", "19:00", "Boston", "Grupos", "I"),
    (94, "CRO", "GHA", "2026-06-24", "22:00", "Miami", "Grupos", "L"),
    (95, "BRA", "SCO", "2026-06-24", "22:00", "Miami", "Grupos", "C"),
    (96, "HAI", "MAR", "2026-06-24", "22:00", "Philadelphia", "Grupos", "C"),
]

# Jogos do Mata-Mata (Round of 32, Round of 16, Quartas, Semis, Final)
# Horários já convertidos para Brasília (BRT = ET + 1h no verão)
JOGOS_MATA_MATA = [
    # Round of 32 - 28 de Junho
...
# Todos os jogos
TODOS_JOGOS = JOGOS_FASE_GRUPOS + JOGOS_MATA_MATA
...
FASES = [
    "Grupos",
    "Oitavas32",  # Round of 32
    "Oitavas16",  # Round of 16
    "Quartas",
    "Semifinal",
    "Terceiro",
    "Final"
