...
MATCHES_GROUP_STAGE = [
    ...
    # GRUPO A - 6 jogos
    # ========================================
    (1, 'A', 'Mexico', 'South Africa', '2026-06-11', '16:00', 'Azteca Stadium, Mexico City'),
    (2, 'A', 'Korea', 'A4', '2026-06-11', '19:00', 'Azteca Stadium, Mexico City'),
    (3, 'A', 'Mexico', 'Korea', '2026-06-18', '13:00', 'Guadalajara Stadium'),
    (4, 'A', 'South Africa', 'A4', '2026-06-18', '16:00', 'Guadalajara Stadium'),
    (5, 'A', 'A4', 'Mexico', '2026-06-24', '16:00', 'Monterrey Stadium'),
    (6, 'A', 'South Africa', 'Korea', '2026-06-24', '16:00', 'Monterrey Stadium'),
    
    # ========================================
    # GRUPO B - 6 jogos
    # ========================================
    (7, 'B', 'England', 'B2', '2026-06-12', '13:00', 'SoFi Stadium, Los Angeles'),
    (8, 'B', 'B3', 'B4', '2026-06-12', '16:00', 'SoFi Stadium, Los Angeles'),
    (9, 'B', 'England', 'B3', '2026-06-19', '13:00', 'Levi\'s Stadium, San Francisco'),
    (10, 'B', 'B2', 'B4', '2026-06-19', '16:00', 'Levi\'s Stadium, San Francisco'),
    (11, 'B', 'B4', 'England', '2026-06-25', '16:00', 'Rose Bowl, Los Angeles'),
    (12, 'B', 'B2', 'B3', '2026-06-25', '16:00', 'Rose Bowl, Los Angeles'),
    
    # ========================================
    # GRUPO C - 6 jogos
    # ========================================
    (13, 'C', 'Argentina', 'C2', '2026-06-12', '19:00', 'MetLife Stadium, New York'),
    (14, 'C', 'C3', 'C4', '2026-06-13', '13:00', 'MetLife Stadium, New York'),
    (15, 'C', 'Argentina', 'C3', '2026-06-20', '13:00', 'AT&T Stadium, Dallas'),
    (16, 'C', 'C2', 'C4', '2026-06-20', '16:00', 'AT&T Stadium, Dallas'),
    (17, 'C', 'C4', 'Argentina', '2026-06-26', '16:00', 'Hard Rock Stadium, Miami'),
    (18, 'C', 'C2', 'C3', '2026-06-26', '16:00', 'Hard Rock Stadium, Miami'),
    
    # ========================================
    # GRUPO D - 6 jogos
    # ========================================
    (19, 'D', 'France', 'D2', '2026-06-13', '16:00', 'BMO Field, Toronto'),
    (20, 'D', 'D3', 'D4', '2026-06-13', '19:00', 'BMO Field, Toronto'),
    (21, 'D', 'France', 'D3', '2026-06-21', '13:00', 'BC Place, Vancouver'),
    (22, 'D', 'D2', 'D4', '2026-06-21', '16:00', 'BC Place, Vancouver'),
    (23, 'D', 'D4', 'France', '2026-06-27', '16:00', 'Gillette Stadium, Boston'),
    (24, 'D', 'D2', 'D3', '2026-06-27', '16:00', 'Gillette Stadium, Boston'),
    
    # ========================================
    # GRUPO E - 6 jogos
    # ========================================
    (25, 'E', 'Spain', 'E2', '2026-06-14', '13:00', 'Lincoln Financial Field, Philadelphia'),
    (26, 'E', 'E3', 'E4', '2026-06-14', '16:00', 'Lincoln Financial Field, Philadelphia'),
    (27, 'E', 'Spain', 'E3', '2026-06-22', '13:00', 'Mercedes-Benz Stadium, Atlanta'),
    (28, 'E', 'E2', 'E4', '2026-06-22', '16:00', 'Mercedes-Benz Stadium, Atlanta'),
    (29, 'E', 'E4', 'Spain', '2026-06-28', '16:00', 'Arrowhead Stadium, Kansas City'),
    (30, 'E', 'E2', 'E3', '2026-06-28', '16:00', 'Arrowhead Stadium, Kansas City'),
    
    # ========================================
    # GRUPO F - 6 jogos
    # ========================================
    (31, 'F', 'Brazil', 'F2', '2026-06-14', '19:00', 'Lumen Field, Seattle'),
    (32, 'F', 'F3', 'F4', '2026-06-15', '13:00', 'Lumen Field, Seattle'),
    (33, 'F', 'Brazil', 'F3', '2026-06-23', '13:00', 'NRG Stadium, Houston'),
    (34, 'F', 'F2', 'F4', '2026-06-23', '16:00', 'NRG Stadium, Houston'),
    (35, 'F', 'F4', 'Brazil', '2026-06-29', '16:00', 'SoFi Stadium, Los Angeles'),
    (36, 'F', 'F2', 'F3', '2026-06-29', '16:00', 'SoFi Stadium, Los Angeles'),
    
    # ========================================
    # GRUPO G - 6 jogos
    # ========================================
    (37, 'G', 'Germany', 'G2', '2026-06-15', '16:00', 'Levi\'s Stadium, San Francisco'),
    (38, 'G', 'G3', 'G4', '2026-06-15', '19:00', 'Levi\'s Stadium, San Francisco'),
    (39, 'G', 'Germany', 'G3', '2026-06-24', '13:00', 'Rose Bowl, Los Angeles'),
    (40, 'G', 'G2', 'G4', '2026-06-24', '16:00', 'Rose Bowl, Los Angeles'),
    (41, 'G', 'G4', 'Germany', '2026-06-30', '16:00', 'MetLife Stadium, New York'),
    (42, 'G', 'G2', 'G3', '2026-06-30', '16:00', 'MetLife Stadium, New York'),
    
    # ========================================
    # GRUPO H - 6 jogos
    # ========================================
    (43, 'H', 'Portugal', 'H2', '2026-06-16', '13:00', 'AT&T Stadium, Dallas'),
    (44, 'H', 'H3', 'H4', '2026-06-16', '16:00', 'AT&T Stadium, Dallas'),
    (45, 'H', 'Portugal', 'H3', '2026-06-25', '13:00', 'Hard Rock Stadium, Miami'),
    (46, 'H', 'H2', 'H4', '2026-06-25', '16:00', 'Hard Rock Stadium, Miami'),
    (47, 'H', 'H4', 'Portugal', '2026-07-01', '16:00', 'Arrowhead Stadium, Kansas City'),
    (48, 'H', 'H2', 'H3', '2026-07-01', '16:00', 'Arrowhead Stadium, Kansas City'),
    
    # ========================================
    # GRUPO I - 6 jogos
    # ========================================
    (49, 'I', 'Netherlands', 'I2', '2026-06-16', '19:00', 'BMO Field, Toronto'),
    (50, 'I', 'I3', 'I4', '2026-06-17', '13:00', 'BMO Field, Toronto'),
    (51, 'I', 'Netherlands', 'I3', '2026-06-26', '13:00', 'BC Place, Vancouver'),
    (52, 'I', 'I2', 'I4', '2026-06-26', '16:00', 'BC Place, Vancouver'),
    (53, 'I', 'I4', 'Netherlands', '2026-07-02', '16:00', 'Gillette Stadium, Boston'),
    (54, 'I', 'I2', 'I3', '2026-07-02', '16:00', 'Gillette Stadium, Boston'),
    
    # ========================================
    # GRUPO J - 6 jogos
    # ========================================
    (55, 'J', 'Belgium', 'J2', '2026-06-17', '16:00', 'Lincoln Financial Field, Philadelphia'),
    (56, 'J', 'J3', 'J4', '2026-06-17', '19:00', 'Lincoln Financial Field, Philadelphia'),
    (57, 'J', 'Belgium', 'J3', '2026-06-27', '13:00', 'Mercedes-Benz Stadium, Atlanta'),
    (58, 'J', 'J2', 'J4', '2026-06-27', '16:00', 'Mercedes-Benz Stadium, Atlanta'),
    (59, 'J', 'J4', 'Belgium', '2026-07-03', '16:00', 'NRG Stadium, Houston'),
    (60, 'J', 'J2', 'J3', '2026-07-03', '16:00', 'NRG Stadium, Houston'),
    
    # ========================================
    # GRUPO K - 6 jogos
    # ========================================
    (61, 'K', 'Italy', 'K2', '2026-06-18', '13:00', 'Lumen Field, Seattle'),
    (62, 'K', 'K3', 'K4', '2026-06-18', '16:00', 'Lumen Field, Seattle'),
    (63, 'K', 'Italy', 'K3', '2026-06-28', '13:00', 'SoFi Stadium, Los Angeles'),
    (64, 'K', 'K2', 'K4', '2026-06-28', '16:00', 'SoFi Stadium, Los Angeles'),
    (65, 'K', 'K4', 'Italy', '2026-07-04', '16:00', 'Levi\'s Stadium, San Francisco'),
    (66, 'K', 'K2', 'K3', '2026-07-04', '16:00', 'Levi\'s Stadium, San Francisco'),
    
    # ========================================
    # GRUPO L - 6 jogos
    # ========================================
    (67, 'L', 'Uruguay', 'L2', '2026-06-18', '19:00', 'Rose Bowl, Los Angeles'),
    (68, 'L', 'L3', 'L4', '2026-06-19', '13:00', 'Rose Bowl, Los Angeles'),
    (69, 'L', 'Uruguay', 'L3', '2026-06-29', '13:00', 'MetLife Stadium, New York'),
    (70, 'L', 'L2', 'L4', '2026-06-29', '16:00', 'MetLife Stadium, New York'),
    (71, 'L', 'L4', 'Uruguay', '2026-07-05', '16:00', 'AT&T Stadium, Dallas'),
...
MATCHES_KNOCKOUT = [
    ...
    (85, 'R16', '1I', '3A/D/E/F', '2026-07-14', '13:00', 'MetLife Stadium, New York'),
    (86, 'R16', '1J', '3B/C/G/H', '2026-07-14', '16:00', 'Lumen Field, Seattle'),
    (87, 'R16', '1K', '3A/B/C/D', '2026-07-15', '13:00', 'Azteca Stadium, Mexico City'),
    (88, 'R16', '1L', '3E/F/G/H', '2026-07-15', '16:00', 'Guadalajara Stadium'),
