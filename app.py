...
# URLs das imagens (hospedadas no GitHub ou CDN)
LOGO_COPA_2026 = "https://upload.wikimedia.org/wikipedia/pt/thumb/5/57/2026_FIFA_World_Cup_emblem.svg/200px-2026_FIFA_World_Cup_emblem.svg.png"
MASCOTES_COPA_2026 = "https://i.imgur.com/YqKJ8Zx.png"

st.markdown("""
<style>
    /* ========================================
       VARIÁVEIS DE CORES - COPA 2026
       ======================================== */
    :root {
        --copa-azul: #1E3A5F;
        --copa-azul-claro: #3498db;
        --copa-vermelho: #E63946;
        --copa-verde: #2D6A4F;
        --copa-dourado: #D4AF37;
        --copa-laranja: #F77F00;
        --copa-roxo: #7B2CBF;
        --copa-bg-gradient: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
        --copa-card-bg: linear-gradient(145deg, #ffffff 0%, #f0f4f8 100%);
    }
    ...
    .main-header {
        font-size: 2.8rem;
        font-weight: 800;
        background: linear-gradient(90deg, #1E3A5F, #3498db, #E63946);
...
def page_login():
    ...
    with col2:
        ...
        <div class="logo-container">
            <img src="{LOGO_COPA_2026}" class="logo-copa" alt="Copa do Mundo 2026">
        </div>
        ''', unsafe_allow_html=True)
