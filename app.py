...
def page_login():
    ...
    # URL da imagem dos mascotes (substitua pela URL do seu repositório GitHub)
    # Exemplo: https://raw.githubusercontent.com/LeandroCrepo/bolao-copa-2026/main/mascotes.png
    MASCOTES_URL = "https://raw.githubusercontent.com/LeandroCrepo/bolao-copa-2026/main/mascotes.png"
    
    # Imagem dos mascotes
    st.markdown(f'''
    <div style="text-align: center; margin-bottom: 1rem;">
        <img src="{MASCOTES_URL}" alt="Mascotes Copa 2026" style="max-width: 350px; height: auto;">
    </div>
    ''', unsafe_allow_html=True)
...
def page_home():
    ...
    # URL da imagem dos mascotes
    MASCOTES_URL = "https://raw.githubusercontent.com/LeandroCrepo/bolao-copa-2026/main/mascotes.png"
    
    # Imagem dos mascotes (menor na home)
    st.markdown(f'''
    <div style="text-align: center; margin-bottom: 0.5rem;">
        <img src="{MASCOTES_URL}" alt="Mascotes Copa 2026" style="max-width: 200px; height: auto;">
    </div>
    ''', unsafe_allow_html=True)
